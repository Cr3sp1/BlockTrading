...
# Imposta il backend di Matplotlib su TkAgg
...
def main():
    while True:
        ...
        for i in range(3):
            ...
            axs[i].set_xlim(0, 1.2 * tokeninit)
            axs[i].set_ylim(0, 6 * paycoininit)
        ...
        plt.draw()  # Disegna il grafico

        # Aspetta 30 secondi prima di aggiornare
        plt.pause(30)
        plt.close(fig)  # Chiudi la finestra del grafico
